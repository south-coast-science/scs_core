...
class DeviceMonitorManager(APIClient):
    """
    classdocs
    """

    __URL = "https://n0ctatmvjl.execute-api.us-west-2.amazonaws.com/default/DeviceMonitorManager"   # TODO: update URL
