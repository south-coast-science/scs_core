...
The vXCal field can only be computed when the NO2 concentration is known prceisely, so this should be done
...
class A4CalibratedDatum(A4Datum):
    ...
    def __init__(self, we_v, ae_v, we_c, cnc, v_cal, v_x_cal):
        ...
        self.__v_x_cal = Datum.float(v_x_cal, 3)                # calibrated voltage from NO2 cross-sensitivity
