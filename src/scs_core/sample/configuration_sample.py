...
"model-interface": "vB"}, "gps-conf": {"model": "SAM8Q", "sample-interval": 10, "tally": 60, "debug": false},
"interface-conf": {"model": "DFE"},
...
"batt-model": null, "ignore-threshold": false, "reporting-interval": 20}, "psu-version": null,
