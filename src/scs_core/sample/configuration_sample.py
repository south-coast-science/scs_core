...
"report-file": "/dev/shm/southcoastscience/gps_report.json", "debug": false}, "interface-conf": {"model": "DFE"},
...
"report-file": "/dev/shm/southcoastscience/psu_status_report.json"}, "psu-version": null,
