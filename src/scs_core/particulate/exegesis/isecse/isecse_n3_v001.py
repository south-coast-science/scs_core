...
class ISECSEN3v1(ISECSE):
    ...
    __STANDARD_CE['pm1'] =              0.059
    __STANDARD_CE['pm2p5'] =            0.0797
    __STANDARD_CE['pm10'] =             0.0828

    __STANDARD_CX = OrderedDict()
    __STANDARD_CX['pm1'] =              0.0635
    __STANDARD_CX['pm2p5'] =            0.063
    __STANDARD_CX['pm10'] =             0.0105
