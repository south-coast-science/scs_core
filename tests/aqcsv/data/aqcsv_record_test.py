...
record1 = AQCSVRecord(site_code='124MM456789123', data_status=2, action_code=3, datetime_code='20081008T1800-0600',
                      parameter=5, duration=6, frequency=7, value=8, unit=9, qc=10,
...
first1 = AQCSVFirstRecord('124456789123', 2, '20081008T1800', 4, 5, 6, 7, 8, 9, 10, 11)
print("first1: %s" % first1)

first2 = AQCSVFirstRecord('124456789123', 2, '20081008T1800', 4, 5, 6, 7, 8, 9, 10, 11)
...
subsequent = AQCSVSubsequentRecord('124MM456789123', 2, 3, 4, 5, 6, 7, 8, 9)
